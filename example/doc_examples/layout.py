...
class WidthState:
    value: float = 0.5
    show_indented: bool = True


@dataclass
class GroupSizingState:
    selection: int = 0
...
class TabsState:
    counter: int = 0
    closable_details: bool = True


@example(category="layout", title="Master-detail layout with tabs", state_constructor=LayoutState)
...
@example(category="layout", title="Item width patterns", state_constructor=WidthState)
...
@example(category="layout", title="Group sizing", state_constructor=GroupSizingState)
...
@example(category="layout", title="Horizontal layout with same_line()")
...
@example(category="layout", title="Text baseline alignment")
...
@example(category="layout", title="Basic tab bar", state_constructor=TabsState)
