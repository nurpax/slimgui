...
#     IMGUI_DEMO_MARKER("Widgets");
    ...
    if not hasattr(show_demo_window_widgets, "statics"):
        show_demo_window_widgets.statics = {
            "i0": 123,
            "i1": 0,
            "i2": (0, 0),
            "f0": 0.001,
    ...
    statics = show_demo_window_widgets.statics
...
#     }
        ...
        if imgui.tree_node("Combo"):
            if not hasattr(show_demo_window_widgets, "combo"):
                show_demo_window_widgets.combo = {
                    "flags": 0,
                    "item_current_idx": 0,
                }
            combo = show_demo_window_widgets.combo
        ...
        if imgui.tree_node("List boxes"):
            if not hasattr(show_demo_window_widgets, "listbox"):
                show_demo_window_widgets.listbox = {
                    "flags": 0,
                    "item_current_idx": 0,
                    "item_current_idx2": 0,
                }
            listbox = show_demo_window_widgets.listbox
            items = ["AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF", "GGGG", "HHHH", "IIII", "JJJJ", "KKKK", "LLLLLLL", "MMMM", "OOOOOOO"]
