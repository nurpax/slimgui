...
nb::enum_<ImGuiConfigFlags_>(m, "ConfigFlags", nb::is_flag(),
    ...
    .value("DPI_ENABLE_SCALE_VIEWPORTS",
           ImGuiConfigFlags_DpiEnableScaleViewports,
           "[BETA: Don't use] FIXME-DPI: Reposition and resize imgui windows "
           "when the DpiScale of a viewport changed (mostly useful for the "
           "main viewport hosting other window). Note that resizing the main "
           "window itself is up to your application.")
    .value("DPI_ENABLE_SCALE_FONTS", ImGuiConfigFlags_DpiEnableScaleFonts,
           "[BETA: Don't use] FIXME-DPI: Request bitmap-scaled fonts to match "
           "DpiScale. This is a very low-quality workaround. The correct way "
           "to handle DPI is _currently_ to replace the atlas and/or fonts in "
           "the Platform_OnChangedViewport callback, but this is all early "
           "work in progress.")
