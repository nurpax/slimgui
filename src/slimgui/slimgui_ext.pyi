...
def set_next_window_collapsed(collapsed: bool, cond: int = Cond.NONE) -> None: ...

def set_next_window_content_size(size: tuple[float, float]) -> None: ...

def set_next_window_focus() -> None: ...

def set_next_window_pos(pos: tuple[float, float], cond: int = Cond.NONE, pivot: tuple[float, float] = (0.0, 0.0)) -> None: ...

def set_next_window_scroll(scroll: tuple[float, float]) -> None: ...

def set_next_window_size(size: tuple[float, float], cond: int = Cond.NONE) -> None: ...
...
@overload
def set_window_collapsed(collapsed: bool, cond: int = Cond.NONE) -> None: ...

@overload
def set_window_collapsed(name: str, collapsed: bool, cond: int = Cond.NONE) -> None: ...
...
@overload
def set_window_pos(pos: tuple[float, float], cond: int = Cond.NONE) -> None: ...

@overload
def set_window_pos(name: str, pos: tuple[float, float], cond: int = Cond.NONE) -> None: ...

@overload
def set_window_size(size: tuple[float, float], cond: int = Cond.NONE) -> None: ...

@overload
def set_window_size(name: str, size: tuple[float, float], cond: int = Cond.NONE) -> None: ...
