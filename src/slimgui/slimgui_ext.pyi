...
def drag_int(label: str, v: int, v_speed: float = 1.0, v_min: int = 0.0, v_max: int = 0.0, format: str = '%.3f', flags: SliderFlags = SliderFlags.NONE) -> tuple[bool, int]: ...

def drag_int2(label: str, v: tuple[int, int], v_speed: float = 1.0, v_min: int = 0.0, v_max: int = 0.0, format: str = '%.3f', flags: SliderFlags = SliderFlags.NONE) -> tuple[bool, tuple[int, int]]: ...

def drag_int3(label: str, v: tuple[int, int, int], v_speed: float = 1.0, v_min: int = 0.0, v_max: int = 0.0, format: str = '%.3f', flags: SliderFlags = SliderFlags.NONE) -> tuple[bool, tuple[int, int, int]]: ...

def drag_int4(label: str, v: tuple[int, int, int, int], v_speed: float = 1.0, v_min: int = 0.0, v_max: int = 0.0, format: str = '%.3f', flags: SliderFlags = SliderFlags.NONE) -> tuple[bool, tuple[int, int, int, int]]: ...
