...
class InputTextCallbackData:
    ...
    @buf.setter
    def buf(self, buf: str | None) -> None: ...

    @property
    def buf_text_len(self) -> int: ...

    @buf_text_len.setter
    def buf_text_len(self, arg: int, /) -> None: ...

    @property
    def buf_size(self) -> int: ...

    @property
    def buf_dirty(self) -> bool: ...

    @buf_dirty.setter
    def buf_dirty(self, arg: bool, /) -> None: ...
    ...
    def insert_chars(self, pos: int, text: str, text_end: str | None = None) -> None: ...
...
def input_text(label: str, text: str, flags: InputTextFlags = InputTextFlags.NONE, callback: object | None = None, user_data: object | None = None) -> tuple[bool, str]:
    ...


def input_text_with_hint(label: str, hint: str, text: str, flags: InputTextFlags = InputTextFlags.NONE, callback: object | None = None, user_data: object | None = None) -> tuple[bool, str]:
    ...


def input_text_multiline(label: str, text: str, size: tuple[float, float] = (0.0, 0.0), flags: InputTextFlags = InputTextFlags.NONE, callback: object | None = None, user_data: object | None = None) -> tuple[bool, str]:
    ...
