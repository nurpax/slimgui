nb::enum_<ImDrawFlags_>(m, "DrawFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiInputTextFlags_>(m, "InputTextFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiButtonFlags_>(m, "ButtonFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiWindowFlags_>(m, "WindowFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiTreeNodeFlags_>(m, "TreeNodeFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiTableFlags_>(m, "TableFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiTableRowFlags_>(m, "TableRowFlags", nb::is_arithmetic())
    .value("NONE", ImGuiTableRowFlags_None)
    .value("HEADERS", ImGuiTableRowFlags_Headers);
nb::enum_<ImGuiTableColumnFlags_>(m, "TableColumnFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiColorEditFlags_>(m, "ColorEditFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiComboFlags_>(m, "ComboFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiSelectableFlags_>(m, "SelectableFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiConfigFlags_>(m, "ConfigFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiBackendFlags_>(m, "BackendFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiHoveredFlags_>(m, "HoveredFlags", nb::is_arithmetic())
...
nb::enum_<ImGuiPopupFlags_>(m, "PopupFlags", nb::is_arithmetic())
