...
if __name__ == "__main__":
    imgui_src = "https://github.com/ocornut/imgui/archive/refs/tags/v1.92.9b.zip"
    cimgui_src = "https://github.com/cimgui/cimgui/archive/refs/tags/1.92.9.zip"  # cimgui has no 1.92.9b tag; 1.92.9 is equivalent.
