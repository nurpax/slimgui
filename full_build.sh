...
python gen/amend_func_docs.py --cimgui-definitions-file gen/cimgui/definitions.json --imgui-h src/c/imgui/imgui.h --pyi-file src/slimgui/imgui_ext/__init__.pyi -o src/slimgui/imgui_ext/__init__.pyi
...
python gen/build_docs.py --imgui-version=${IMGUI_VERSION} --pyi-file src/slimgui/imgui_ext/__init__.pyi --output docs/index.html docs/apiref.md
